...
export default function Navbar() {
  ...
  return (
    <nav className="py-2">
      ...
      <div className="md:px-12 px-6 flex items-center justify-between mx-auto relative">
        <div className="">
          <button className="py-2 md:mt-4 my-2 px-6 bg-[#FAA727] text-lg lemon rounded-md border-black border-b-4 border-r-4">Buy Token</button>
        </div>
